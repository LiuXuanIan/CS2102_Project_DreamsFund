			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<?php
						...
						if(isset($_POST['Save'])) {
							$result = pg_query($db, "UPDATE users SET first_name = '$_POST[first_name]', last_name = '$_POST[last_name]', location = '$_POST[location]' WHERE email = '$accountEmail' ");
							if (!$result) {
					            echo '<meta http-equiv="refresh" content="0; URL = editUserProfileFailure.php" />';
					        } else {
					            echo '<meta http-equiv="refresh" content="0; URL = editUserProfileSuccess.php" />';
					        }
						}
					?>
