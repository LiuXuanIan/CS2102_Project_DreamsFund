		...
		<div class="container">
			<div class="row">
					...
					<form action="#" method="POST">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" name="password" id="password" class="form-control" placeholder="Account Password">
							</div>
						</div>
						
						<div class="row form-group">
							<div class="col-md-12">
								<label for="t_password">Transaction Password</label>
								<input type="text" name="t_password" id="t_password" class="form-control" placeholder="Transaction Password">
							</div>
						</div>
				...
				<?php
					...
					$result = pg_query($db, "SELECT * FROM users where users.email = '$accountEmail'");
					$row    = pg_fetch_assoc($result);
					if (isset($_POST['next'])) {
					  if ($accountEmail=="") {
					    echo '<meta http-equiv="refresh" content="0; URL= signUpFail.php" />';
					  } else {
					    if ($row != null) {
  						  echo '<meta http-equiv="refresh" content="0; URL= signUpExist.php" />';
              } else {
                $p=$_POST[password];
                $t_p=$_POST[t_password];
                ...
                if ($p==""||$t_p==""||$f_n==""||$l_n=="") {
                  ...
                  if (!$result) {
                    ...
                    echo '<meta http-equiv="refresh" content="0; URL=signUpSuccess.php" />';
                  } 
                }
					    } 
					  }
