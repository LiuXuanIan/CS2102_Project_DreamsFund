			...
			<div class="row">
				<div class="col-md-4">
					<div class="box-testimony animate-box">
						...
						<p class="author">Yuqian <a href="index.php" target="_blank"> crowdfunding.com</a> <span class="subtext">Team member</span></p>
					</div>
				...
				<div class="col-md-4">
					<div class="box-testimony animate-box">
						...
						<p class="author">Liu Xuan <a href="index.php" target="_blank"> crowdfunding.com</a> <span class="subtext">Team member</span></p>
					</div>
				...
				<div class="col-md-4">
					<div class="box-testimony animate-box">
						...
						<p class="author">Yiyang <a href="index.php" target="_blank"> crowdfunding.com</a> <span class="subtext">Team member</span></p>
					</div>
				...
				<div class="col-md-4">
					<div class="box-testimony animate-box">
						...
						<p class="author">Jingchen <a href="index.php" target="_blank"> crowdfunding.com</a> <span class="subtext">Team member</span></p>
					</div>
