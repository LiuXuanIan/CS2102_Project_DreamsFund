...
<html>
	...
	<title>DreamsFund &mdash; Free CrowdFunding Web</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Free CrowdFunding Web" />
	<meta name="keywords" content="Free CrowdFunding Web" />
	<meta name="author" content="Free CrowdFunding Web" />
								...
								<form class="form-inline" id="fh5co-header-subscribe">
									<div class="col-md-6 col-md-offset-3">
										<div class="form-group">
											<input type="text" class="form-control" id="email" placeholder="Interested projects">
											<button type="submit" class="btn btn-default">Find it Now</button>
										</div>
									</div>
								</form>
							</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="project_cate.php?cate=agriculture"><img src="cate_img/cate_agriculture.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Agriculture</h3>
						<span>Cultivation</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="project_cate.php?cate=construction"><img src="cate_img/cate_construction.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Construction</h3>
						<span>Structuring</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="project_cate.php?cate=education"><img src="cate_img/cate_education.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Education</h3>
						<span>Improvement</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="project_cate.php?cate=finance"><img src="cate_img/cate_finance.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Finance</h3>
						<span>Commerce</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="project_cate.php?cate=health"><img src="cate_img/cate_health.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Health</h3>
						<span>Fitness</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="project_cate.php?cate=manufacturing"><img src="cate_img/cate_manufacturing.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Manufacturing</h3>
				...
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="project_cate.php?cate=professional"><img src="cate_img/cate_professional.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Professional</h3>
						<span>Competent</span>
					</a>
				</div>
				...
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="project_cate.php?cate=services"><img src="cate_img/cate_services.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Services</h3>
						<span>Supply</span>
					</a>
				</div>
				...
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="project_cate.php?cate=transportation"><img src="cate_img/cate_transportation.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
				...
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="project_cate.php?cate=wholesale"><img src="cate_img/cate_wholesale.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Wholesale</h3>
						<span>Extensive</span>
					</a>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="box-testimony animate-box">
						...
						<p class="author">Mark Zuckerberg, Facebook CEO <a href="facebook.com">facebook.com</a> <span class="subtext">Facebook Initiator</span></p>
					</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<?php
					...
					$result  = pg_query($db, "SELECT * FROM project_initiated_by ORDER BY startdate DESC LIMIT 3");
					$row    = pg_fetch_all($result);
					for ($x = 0; $x < 3; $x++){
						echo "
						<div class='col-lg-4 col-md-4'>
						<div class='fh5co-blog animate-box' data-animate-effect='fadeIn'>
							<a href='#'><img class='img-responsive' src='proj_img/proj_$x.jpg'></a>
							<div class='blog-text'>
							<h3>".$row[$x][title]."</h3>
							<span class='posted_on'>".$row[$x][startdate]."</span>
							<span class='comment'><a href=''>".$row[$x][current_funding]."<i class='icon-speech-bubble'></i></a></span>
							<p>".$row[$x][description]."</p>
							<a href='projectDetail.php?"."arg1=".$row[$x][projectid]."' class='btn btn-primary'>Read More</a>
							</div>
						</div>
						</div>";
					}
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						...
						<small class="block">Designed by <a href="index.php" target="_blank">FrowdFunding</a></small>
					</p>
					<p>
