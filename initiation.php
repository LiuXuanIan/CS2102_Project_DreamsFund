				...
				<div class="col-md-6 animate-box">
					...
					<form action="#" method="POST">
						...
						<div class="form-group">
							<input type="submit" value="Initiate project" class="btn btn-primary">
						</div>

					</form>		
				</div>
				<?php
					$db = pg_connect("host=localhost port=5432 dbname=Project user=postgres password=1Dcyq7!!");
					if(isset($_POST['Initiate project'])) {
						session_start();
						if (!isset($_SESSION['email'])) {
							...
							if (!$result) {
								header("Location:initiationFailed.php");
	    						exit;
	        				} else {
