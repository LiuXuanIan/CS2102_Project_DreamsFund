		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Interested?</h2>
					<p>Invest in this project to help the company thrive!</p>
				</div>
			</div>
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2">
					<form class="form-inline">
						<div class="col-md-6 col-md-offset-3 col-sm-6">
							<button type="submit" class="btn btn-default btn-block" name="donate">Donate</button>
						</div>
					</form>
					<?php
						if(isset($_POST['donate'])){
							echo '<meta http-equiv="refresh" content="0; URL=donate.php" />';
						}
					?>
				</div>
			</div>
